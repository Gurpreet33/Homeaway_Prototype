...
import { signowner } from "../../actions/signupactions";
...
class SignupOwner extends Component {
  ...
  handleSignmeup = e => {
    ...
    this.props.signowner(data, this.props.history);
  };
        ...
        <div>
          ...
          <div className="heading">
            ...
            <p className="text-center">
              Already have an account? <Link to="/loginowner">Log In</Link>
            </p>
          </div>
          <section className="login-block loginow">
...
const mapStateToProps = state => {
  return {
    ownerSignFlag: state.signReducer.ownerSignFlag,
