...
import { details } from "../../actions/listPropertyActions";
...
class Details extends Component {
  ...
  handleNext = e => {
    console.log("I am in details component in next button click");
    const data = {
    ...
    this.props.details(data, this.props.history);
  };
                              ...
                              <div className="container">
                                <div class="row">
                                  <div className="col-md-6 login-sec">
                                    ...
                                    >
                                      <span>
                                        Start out with a descriptive headline
                                        and a detailed summary of your property.
                                      </span>
                                    </p>
                                        ...
                                        <div className="form-group floating-label not-empty">
                                          <div className="FormSelect__wrapper">
                                            ...
                                            <textarea
                                              ...
                                              type="text"
                                              className="form-control"
                                              onChange={this.handlePropertyDes}
                                              required
                                        ...
                                        <div className="form-group floating-label not-empty">
                                          <div className="FormSelect__wrapper">
                                            ...
                                            <input
                                              style={{ height: "60px" }}
                                              type="number"
                                              onChange={this.handleAccomodates}
                                              className="form-control"
                                              required
...
const mapStateToProps = state => {
  return {
    ...
    DetailsFlag: state.listPropertyReducer.DetailsFlag,
